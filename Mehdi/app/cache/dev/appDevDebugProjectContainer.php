...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mehdi.antispam' => 'getMehdi_AntispamService',
            'mehdi.doctrine.notification' => 'getMehdi_Doctrine_NotificationService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventListener(array(0 => 'postPersist'), $this->get('mehdi.doctrine.notification'));
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/UserBundle/Resources/config/doctrine') => 'UserBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/MehdiBundle/Entity'))), 'MehdiBundle\\Entity');
        $b->addDriver($a, 'UserBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('MehdiBundle' => 'MehdiBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3ac90677ccae0b7a7da1bf7c8e00eeb3fd5cc40d78cb7e9a811eae788ac57204');
    ...
    /**
     * Gets the 'mehdi.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MehdiBundle\Antispam\Antispam A MehdiBundle\Antispam\Antispam instance.
     */
    protected function getMehdi_AntispamService()
    {
        return $this->services['mehdi.antispam'] = new \MehdiBundle\Antispam\Antispam($this->get('swiftmailer.mailer.default'), 'en', 50);
    }

    /**
     * Gets the 'mehdi.doctrine.notification' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MehdiBundle\DoctrineListener\ApplicationNotification A MehdiBundle\DoctrineListener\ApplicationNotification instance.
     */
    protected function getMehdi_Doctrine_NotificationService()
    {
        return $this->services['mehdi.doctrine.notification'] = new \MehdiBundle\DoctrineListener\ApplicationNotification($this->get('swiftmailer.mailer.default'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MehdiBundle/Resources/views'), 'Mehdi');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('26e4bede4929c5abce90ee5eca0ca7abf3f426c7');
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('superadmin', 'superadminpass', array(0 => 'ROLE_SUPER_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MehdiBundle' => 'MehdiBundle\\MehdiBundle',
            ...
            'secret' => '26e4bede4929c5abce90ee5eca0ca7abf3f426c7',
            'locale' => 'en',
            ...
            'kernel.secret' => '26e4bede4929c5abce90ee5eca0ca7abf3f426c7',
